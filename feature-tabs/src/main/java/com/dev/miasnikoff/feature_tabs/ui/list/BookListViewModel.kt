            ...
            currentState?.let { state ->
                ...
                if (index > -1 && bookItem != null) {
                    newList[index] = if (bookItem.isFavorite) {
                        ...
                        bookItem.copy(isFavorite = false, favoriteIcon = com.dev.miasnikoff.core_ui.R.drawable.ic_bookmark_border_24)
                    }
                    else {
                        interactor.saveInFavorite(bookItem)
                        bookItem.copy(isFavorite = true, favoriteIcon = com.dev.miasnikoff.core_ui.R.drawable.ic_bookmark_24)
                    }
                }
                currentList = newList
